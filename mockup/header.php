    <!-- Navbar -->
    <div id="logo"><img src="/assets/img/logo_coop_png.png" loading="lazy" class="img-fluid"/></div>
            <section id="header">
                <div class="system_name"><h1>ระบบทะเบียนสมาชิกและหุ้น</h1></div>
            </section>
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                <!-- Left navbar links -->
                <ul class="navbar-nav mainmenu">
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="../../index3.html" class="nav-link"><i class="fa fa-home"></i> หน้าหลัก</a>
                    </li>
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="#" class="nav-link"><i class="fas fa-laptop-code"></i> โปรแกรม</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fas fa-print"></i> ประจำวัน</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                            <li><a href="#" class="dropdown-item">สมัครสมาชิกใหม่ (ปกติ)</a></li>
                            ...
                            <a id="dropdownSubMenu2" href="#" role="button" aria-haspopup="true" aria-expanded="true" class="dropdown-item dropdown-toggle">แก้ไข</a>
