                    ...
                    <form class="form-inline">
                        <div class="form-group mb-4">
                            ...
                            <div class="card-tools">
                                <button id="get_report" type="button" class="btn btn-block btn-primary"
                                    onclick="return data_dict()"><i class="fas fa-play"></i> &nbsp;&nbsp;&nbsp;
                                    ดึงข้อมูล </button>
                            </div>
                        </div>
                    </form>
...
function data_dict() {
    ...
    $.ajax({
        type: 'post',
        url: "<?php echo site_url('/Data_dict/get_data_dict') ?>",
        data: p,
        dataType: 'html',
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    <img class="img-circle img-bordered-sm"
                                                        src="<?php echo ASSETS_URL; ?>/dist/img/user1-128x128.jpg"
                                                        alt="user image">
                                                    <span class="username">
                                            ...
                                            <div class="post clearfix">
                                                <div class="user-block">
                                                    <img class="img-circle img-bordered-sm"
                                                        src="<?php echo ASSETS_URL; ?>/dist/img/user7-128x128.jpg"
                                                        alt="User Image">
                                                    <span class="username">
                                                        <a href="#">Sarah Ross</a>
                                                        <a href="#" class="float-right btn-tool"><i
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    <img class="img-circle img-bordered-sm"
                                                        src="<?php echo ASSETS_URL; ?>/dist/img/user6-128x128.jpg"
                                                        alt="User Image">
                                                    <span class="username">
                                                        <a href="#">Adam Jones</a>
                                                        <a href="#" class="float-right btn-tool"><i
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid"
                                                            src="<?php echo ASSETS_URL; ?>/dist/img/photo1.png"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <img class="img-fluid mb-3"
                                                                    src="<?php echo ASSETS_URL; ?>/dist/img/photo2.png"
                                                                    alt="Photo">
                                                                <img class="img-fluid"
                                                                    src="<?php echo ASSETS_URL; ?>/dist/img/photo3.jpg"
                                                                    alt="Photo">
                                                            </div>
                                                            <!-- /.col -->
                                                            <div class="col-sm-6">
                                                                <img class="img-fluid mb-3"
                                                                    src="<?php echo ASSETS_URL; ?>/dist/img/photo4.jpg"
                                                                    alt="Photo">
                                                                <img class="img-fluid"
                                                                    src="<?php echo ASSETS_URL; ?>/dist/img/photo1.png"
                                                                    alt="Photo">
