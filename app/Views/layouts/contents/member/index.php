                ...
                <div class="card-body">
                    <form class="form-inline">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control" id="member_code" placeholder="เลขสมาชิก">
                        </div>
                        ...
                        <div class="form-group mx-sm-2 mb-2">
                            ...
                            <input type="text" class="form-control" id="member_number2" placeholder="เลขสัญญา">
                        </div>
                        <div class="form-group mx-sm-2 mb-2">
                            <label class="sr-only">ชื่อสมาชิก</label>
                            <input type="text" class="form-control" id="member_number3" placeholder="ชื่อสมาชิก">
                        </div>
